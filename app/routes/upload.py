...
def save_to_bucket(bucket, user_id, filename, filepath):
    ...
    :param bucket Name of the bucket used for saving pictures
    :param user_id The ID of the user
    :param filename The name of the picture file
    :param filepath The path on the server of the picture file
    """
...
def save_to_db(filename, url, size, user, phash):
    ...
    :param filename The name of the picture file
    :param url The public url of the picture
    :param size The size in bytes of the picture
    :param user The user model which is the owner of the picture
    :param phash The perceptual hash generated by this picture
    """
